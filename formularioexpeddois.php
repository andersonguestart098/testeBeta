...
<body>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <img src="logo cemear.png.png" alt="200" width="200">
        ...
        <label for="numeronf" class="col-form-label">NÚMERO NF:</label> 
            <input type="text"  name="numeronf" class="form-control" id="numeronf" value="..." placeholder="Preencha o número da nota...">
          </div>
          <br>
          <div class="mb-3">
          <select name="exped" id="exped" value="EXPED.1">
            <option value="EXPED.2">EXPED.2</option>
          </select>
          <BR></BR>
          <div class="mb-3">
          <label for="quemrecebeu" class="col-form-label">SELECIONE O RESPONSÁVEL PELA NOTA FISCAL:</label>
          <BR>
          ...
          <BR></BR>
          <label for="statusdep" class="col-form-label">SELECIONE O STATUS DA NOTA FISCAL:</label>
          <BR>
          <div class="mb-3">
    ...
    <script src="custom.js\customexpeddois.js"></script>
</body>
