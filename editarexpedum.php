...
if (empty($dados['id'])) {
    ...
    $query_usuario = "UPDATE exped SET datahora=:datahora, numeronf=:numeronf, exped=:exped, quemrecebeu=:quemrecebeu, statusdep=:statusdep WHERE id=:id"; //nunca bagunçar essa porra de função se não ele não altera no banco de dados
