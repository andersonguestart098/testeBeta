...
<body>
    <div class="container">
        <div class="row mt-4">
            <div class="col-lg-12">
                <div>
                    <h4>FORMULÁRIO DE SAÍDA DO CAMINHÃO</h4>
                </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <img src="logo cemear.png.png" alt="200" width="200">
        ...
        <div class="mb-3">
        <label for="codentrega" class="col-form-label">CÓDIGO ENTREGA:</label> 
            <input type="text"  name="codentrega" class="form-control" id="codentrega" placeholder="Preencha o número da nota...">
          </div>
          <br>
          <div class="mb-3">
          <select name="motorista" id="motorista" value="MOTORISTA">
            <option value="VANDERLEI">VANDERLEI</option>
            <option value="JULIANO">JULIANO</option>
          </select>
          <br>
          <div class="mb-3">
        <label for="hodometro" class="col-form-label">HODÔMETRO:</label> 
            <input type="text"  name="hodometro" class="form-control" id="hodometro" placeholder="Preencha o número da nota...">
          </div>
          <br>
          <label for="datahora" class="col-form-label">DATA-HORA:</label> 
            <input type="datetime-local"  name="datahora" class="form-control" id="datahora" placeholder="Preencha o número da nota...">
          </div>
          <br>
          <br>
          <label for="obs" class="col-form-label">STATUS LOG:</label> 
            <input type="text"  name="obs" class="form-control" id="obs" placeholder="Preencha o número da nota...">
          </div>
          <br>
    ...
    <script src="custom.js\customsaida.js"></script>
</body>
