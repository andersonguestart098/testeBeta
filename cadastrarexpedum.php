...
if (empty($dados['datahora'])) {
    ...
    $retorna = ['erro' => true, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Necessário preencher o campo numeronf!</div>"];
} elseif (empty($dados['exped'])) {
    $retorna = ['erro' => true, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Necessário preencher o campo exped!</div>"];
    ...
    $retorna = ['erro' => true, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Necessário preencher o campo statusdep!</div>"];
}else {
    $query_usuario = "INSERT INTO exped (datahora, numeronf, exped, quemrecebeu, statusdep) VALUES (:datahora, :numeronf, :exped, :quemrecebeu, :statusdep)"; //se todas array não estiverem escrito corretamente vai retornar um erro 'necessário preencher o campo nome' 
